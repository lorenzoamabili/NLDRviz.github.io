...
d3.tsv("eig_cl5.txt", function(error, data) {
...
d3.tsv("eig_cl7.txt", function(error, data2) {
  if (error) throw error;
  ...
  var color = d3.scale.ordinal().domain([1, 2, 3 , 4, 5, 6, 7]).range(["#9400D3", "#4B0082", "#0000FF", "#00FF00", "#FFFF00" , "#FF7F00", "#FF0000"]);
...
d3.tsv("eig_swiss.txt", function(error, data3) {
  if (error) throw error;
